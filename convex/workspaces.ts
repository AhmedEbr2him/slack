...
// this allows us to provide a new or non member of this workspace because if he is not a member prevent from access mutation
...
export const remove = mutation({
	...
	handler: async (ctx, args) => {
		...
		// delete all members inside workspace
