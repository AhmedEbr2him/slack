...
export const WorkspaceSwitcher = () => {
	...
	const filteredWorkspaces = workspaces?.filter(workspace => workspace._id !== workspaceId); // avoid render current active workspace

	const onClickWorkspace = (id: string | undefined) => {
		...
		<DropdownMenu>
			...
			<DropdownMenuContent
				...
				<DropdownMenuItem
					...
					onClick={() => onClickWorkspace(workspace?._id)}>
					{workspace?.name}
